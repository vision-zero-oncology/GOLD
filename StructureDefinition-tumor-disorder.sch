...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>Condition.onset[x].extension 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>Condition.onset[x].start 1</sch:title>
    <sch:rule context="f:Condition/f:onset[x]/f:start">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Condition.onset[x].start.extension 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>Condition.onset[x].end 1</sch:title>
    <sch:rule context="f:Condition/f:onset[x]/f:end">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Condition.onset[x].end.extension 1</sch:title>
